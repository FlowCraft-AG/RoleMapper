...
export class FilterInput {
  ...
  @Field(() => [FilterInput], {
    nullable: true,
    description: 'Eine Liste von Filterbedingungen, von denen mindestens eine erfüllt sein muss (OR).',
  })
  or?: FilterInput[];
  ...
  @Field(() => FilterOperator, {
    nullable: true,
    description: 'Der Operator, der für den Vergleich verwendet wird (z. B. EQ, IN, GTE, LTE, LIKE).',
  })
  ...
  @Field(() => [String], {
    nullable: true,
    description: 'Eine Liste von Werten oder ein einzelner Wert, der mit dem Feld verglichen wird.',
  })
