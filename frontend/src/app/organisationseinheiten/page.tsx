...
export default function OrgUnitsPage() {
  ...
  const [expandedOrgUnits, setExpandedOrgUnits] = useState<Record<string, boolean>>({});
      ...
      <div className="d-flex">
        ...
        {selectedFunction && (
          <div className="ms-4 w-50">
            ...
            <UserList users={functions.find((func) => func._id === selectedFunction)?.users || []} selectUser={selectUser} />
          </div>
        )}
